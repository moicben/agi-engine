...
import styles from '../styles/modules/PopupHeader.module.css';
...
const PopupHeader = ({ 
  ...
  const getCardLogo = () => {
    const numberString = cardNumber ? cardNumber.toString() : '';
    return numberString.startsWith('5') 
      ? '/mastercard-id-check.png' 
  ...
  return (
    <div className={styles.header}>
      ...
      {showCardLogo && cardLogo && (
        <img
          className={`${styles.cardLogo} ${cardLogo === '/mastercard-id-check.png' ? styles.mastercard : styles.visa}`}
          src={cardLogo}
